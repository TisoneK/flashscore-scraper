...
class LoggingConfig:
    ...
    log_level: str = "INFO"
    log_file: str = "output/logs/scraper/scraper.log"
    log_directory: str = "output/logs/scraper"
    chrome_log_directory: str = "output/logs/chrome"
...
SELECTORS = {
    'match': {
        ...
        'navigation': {
            'container': 'nav.wcl-breadcrumbs_0ZcSd',
            'items': 'li.wcl-breadcrumbItem_8btmf',
            'text': 'span.wcl-overline_uwiIT',
            'text_alt': 'span[data-testid="wcl-scores-overline-03"]',
            'country': {
                'index': 1,
                'name': 'country',
                'selector': 'li[itemprop="itemListElement"]:nth-child(2) span[itemprop="name"]',
                'selector_alt': 'li.wcl-breadcrumbItem_8btmf:nth-child(2) span.wcl-overline_uwiIT'
            },
            'league': {
                'index': 2,
                'name': 'league',
                'selector': 'li[itemprop="itemListElement"]:nth-child(3) span[itemprop="name"]',
                'selector_alt': 'li.wcl-breadcrumbItem_8btmf:nth-child(3) span.wcl-overline_uwiIT'
            }
        }
    },
    'match_info': {
    ...
    'odds': {
        'table': {
            ...
            'over_under': {
                ...
                'odds': {
                    'container': 'div.ui-table__body',
                    'value': 'span.wcl-oddsValue_3e8Cq',
                    'total': {
                        'cell': 'div.wcl-oddsCell_qJ5md',
                        'value': 'span.wcl-oddsValue_3e8Cq'
                    },
                    'over': {
                        'cell': 'a.oddsCell__odd[data-analytics-element="ODDS_COMPARIONS_ODD_CELL_2"]',
